...
import { NavProjects } from "@/components/molecules/dashboard/nav-projects"
            ...
            <SidebarMenuButton size="lg" asChild>
              <a href="#">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Bradi Templates</span>
                  <span className="truncate text-xs">Free Next.js Templates</span>
                </div>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
